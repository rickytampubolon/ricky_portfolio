    ...
    <Layout>
      ...
      */}
      <div className={`flex-1 flex flex-col ${willAnimate ? "will-animate" : ""} ${heroRevealed ? "is-revealed" : ""}`}>
        ...
        ─────────────────────────────────────────────────────────── */}
        <section
          className="flex-1 flex items-center px-5 sm:px-6 md:px-12 py-6 md:py-8"
          aria-label="Hero"
        >
          ...
          <div className="w-full max-w-5xl mx-auto flex flex-col md:flex-row md:items-center gap-6 md:gap-16">
              ...
              >
                ...
                <div className="flex flex-row items-center gap-4 md:flex-col md:items-center md:text-center">
                  ...
                  <div className="flex-1 min-w-0 md:flex md:flex-col md:items-center">
                    ...
                    {/* Domain tags */}
                    <p className="text-[0.55rem] font-bold tracking-[0.16em] uppercase text-[#AAAAAA] dark:text-[#555555] leading-loose hidden sm:block">
                      LOGISTICS&nbsp;•&nbsp;FULFILLMENT<br className="hidden md:block" />
                      <span className="md:hidden"> • </span>ELECTRIC MOBILITY<br className="hidden md:block" />
                      <span className="md:hidden"> • </span>DIGITAL TRANSFORMATION
                    </p>
                  </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              {/* Bio paragraph */}
              <div className="reveal-item mb-4" style={stagger(2)}>
